/*
  bridge_server_file.js
  ----------------------
  File-watching alternative to bridge_server.js, for use with
  location_bridge_file.lua (no LuaSocket required on the BizHawk side).
  ...
  Run it with:
    node bridge_server_file.js "FULL_PATH_TO\location_bridge_output.json"
...
const WATCH_FILE = process.argv[2] || path.join(__dirname, "location_bridge_output.json");
const HTTP_PORT = 5556;
const POLL_MS = 250;
